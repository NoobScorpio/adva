                        ...
                        builder: (context, state) {
                          if (state is AdsInitialState) {
                            ...
                            if (state.ads == null) {
                              ...
                              // return CarouselSlider.builder(itemCount: images.length, itemBuilder: (context,index,idx)=>images[index], options: CarouselOptions(
                              //
                              // ));
                              return Carousel(
                            ...
                            return buildErrorUi("Ads not available");
                          } else {
                            return buildErrorUi('Ads not available');
                          }
                        },
                    ...
                    builder: (context, state) {
                      if (state is OfferInitialState) {
                        ...
                        if (state.offer == null && state.bundle == null) {
                          return buildErrorUi(
                              "No offers data available at the moment");
                        }
                          ...
                          builder: (context, state) {
                            if (state is SellerInitialState) {
                              ...
                              if (state.seller == null) {
                                ...
                                return InkWell(
                                  onTap: () {
                                    print(sellerIndex % selling.length);
                                    print(selling[sellerIndex % selling.length]
                                        .id);
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (_) => ProductViewScreen(
                                                  pid: selling[sellerIndex %
                                                          selling.length]
                                                      .id,
                                                )));
                                  },
                              ...
                              return buildErrorUi(
                                  'Top selling not available at the moment');
                            }
                          },
                        ),
                      ),
                  ...
                  builder: (context, state) {
                    ...
                    if (state is FeaturedInitialState) {
                      ...
                      if (state.featured == null) {
                        ...
                        return makeProducts(screenHeight, screenWidth,
                            state.featured, true, context);

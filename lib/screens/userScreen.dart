...
class Account2Screen extends StatefulWidget {
  @override
  _Account2ScreenState createState() => _Account2ScreenState();
}

class _Account2ScreenState extends State<Account2Screen> {
  @override
